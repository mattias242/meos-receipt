...
| KRAV-17 | Kvittosidan ska gå att läsa i mobil utomhus: text mot bakgrund uppfyller WCAG AA (4,5:1 för brödtext, 3:1 för stor text), inklusive kvittots statusfärger. Färgerna läses ur `public/styles.css` och kontrolleras automatiskt, så att en framtida omfärgning inte tyst försämrar läsbarheten. | `test/tillganglighet.test.js` |
